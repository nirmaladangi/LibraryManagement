...
public static void main(String[] args)
	...
	public static void login() {
		    ...
		    l1.setBounds(300,170, 100,30); //x axis, y axis, width, height 
			...
			login_but.setBounds(450,250,80,25);//Dimensions for button
...
public static Connection connect()
{
      ...
      try {
              ...
              Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library?user=root&password=root");
...
public static void admin_menu() {
	...
	view_but.setBounds(180,180,120,25);//x axis, y axis, width, height 
	view_but.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e){
	...
	issued_but.setBounds(440,180,160,25);//x axis, y axis, width, height 
	...
	add_user.setBounds(180,220,120,25); //set dimensions for button
	...
	add_book.setBounds(310,220,120,25); 
	...
	issue_book.setBounds(610,180,120,25); 
	...
	return_book.setBounds(440,220,160,25); 
	...
	return_book.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e){
				...
				create_but.addActionListener(new ActionListener() {
					...
					//if(ex.days&amp;amp;amp;amp;amp;amp;amp;amp;amp;amp;amp1;gt;diff_int) { //If number of days are more than the period then calculcate fine
